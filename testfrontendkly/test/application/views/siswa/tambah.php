...
<!--<![endif]-->
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="page-title">
                                    <h1 class="title-edit"><i class="fa fa-graduation-cap"></i> Tambah Siswa</h1>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 text-right">
                                <div class="pencarian-layout form-inline">
                                    <div class="form-group text-center">
                                        <a href="#" role="button" class="btn btn-primary save-tambah-siswa">
                            ...
                            <div class="col-md-12">
                                <div class="portlet custom light bordered">
                                    <div class="portlet-body">
                                        <form method="POST" action="ajax-siswa.html" class="form-horizontal form-tambah-siswa">
        ...
        <script>
            ...
            $(".save-tambah-siswa").click(function() {
